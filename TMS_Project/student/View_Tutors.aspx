            ...
            <ItemTemplate>
                <div class="col-md-4">
                    <div class="card bg-dark text-white text-center">
                        ...
                        <div class="card-body">
                            <small style="font-size: 15px; color: lightsteelblue">Email</small>
                            <h5>
                            ...
                            <small style="font-size: 15px; color: lightsteelblue">Experience</small>
                            <h5>
                        ...
                        <div class="card-footer">
                             <small style="font-size: 15px; color: lightsteelblue">Degree</small>
